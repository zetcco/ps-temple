        ...
        return(
            <div className="card lg:card-side bg-base-100 shadow-xl m-10">
                ...
                <div className="absolute top-0 right-0 p-7">
                    <a href="#modal-delete-confirm" className="text-neutral hover:text-error">
                ...
                <div className="modal" id="modal-delete-confirm">
                    <div className="modal-box">
                        <h3 className="font-bold text-lg">Confirm Delete</h3>
                        <p className="py-4">Are you sure you want to delete this template?</p>
                        <div className="modal-action">
                            <a href="#" className="btn btn-outline btn-error">Cancel</a>
                            <a href="#" className="btn btn-error" onClick={handleDelete}>Delete</a>
                        </div>
                    </div>
                </div>
            </div> 
